...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postalDiagnostics = __webpack_require__(5);

	var _postalDiagnostics2 = _interopRequireDefault(_postalDiagnostics);
	...
	var mixin = (0, _lodash.assign)(Messenger, _events2["default"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (root, factory) {
	    if (true) {
	        // AMD. Register as an anonymous module.
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(6), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, postal) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var triggerApi = function triggerApi(obj, name, cb, args) {
	  if (obj._events) {
	...
	var eventsApi = function eventsApi(iteratee, memo, name, callback, context, ctx) {
	  var names = undefined,
	      length = undefined,
	      i = 0;

	  if (name && typeof name === "object") {
	    for (names = (0, _lodash.keys)(name); i < names.length; i++) {
	...
	var onApi = function onApi(events, name, callback, context, ctx) {
	  if (callback) {
	...
	var offApi = function offApi(events, name, callback, context) {
	  // Remove all callbacks for all events
	  if (!events || !name && !context && !callback) {
	    return;
	  }

	  var names = name ? [name] : (0, _lodash.keys)(events);
	  ...
	  if (!(0, _lodash.isEmpty)(events)) {
	    return events;
	  }
	};

	var internalStopListening = function internalStopListening(listener, obj, name, callback, offEvents) {
	  var listeningTo = listener._listeningTo,
	      ids = obj ? [obj._listenId] : (0, _lodash.keys)(listeningTo);
	  ...
	  if ((0, _lodash.isEmpty)(listeningTo)) {
	...
	var onceMap = function onceMap(name, callback, offer) {
	  return eventsApi(function (map, name, callback, offer) {
	    if (callback) {
	      (function () {
	        var once = map[name] = (0, _lodash.once)(function () {
	          offer(name, once);
	...
	var addUnderscoreMethods = function addUnderscoreMethods(Class, methods, attribute) {
	  (0, _lodash.each)(methods, function (length, method) {
	    if (_[method]) {
	...
	var Events = {
	  ...
	  off: function off(name, callback, context) {
	    ...
	    if (listeners) {
	      ...
	      var ids = context != null ? [context_listenId] : (0, _lodash.keys)(listeners);
	      ...
	      if ((0, _lodash.isEmpty)(listeners)) {
	  ...
	  once: function once(name, callback, context) {
	    ...
	    var events = onceMap(name, callback, (0, _lodash.bind)(this.off, this));
	  ...
	  listenTo: function listenTo(obj, name, callback) {
	    ...
	    var id = obj._listenId || (obj._listenId = (0, _lodash.uniqueId)("l")),
	    ...
	    if (!listening) {
	      ...
	      id = this._listenId || (this._listenId = (0, _lodash.uniqueId)("l"));
	  ...
	  listenToOnce: function listenToOnce(obj, name, callback) {
	    // Map the event into a `{ event: once }` object
	    var events = onceMap(name, callback, (0, _lodash.bind)(this.stopListening, this, obj));
